...
public class SharePreferenceUtil {
	...
	private String SHARED_KEY_NIGHT = "shared_key_night";
	...
	public boolean isAllowNight() {
		return mSharedPreferences.getBoolean(SHARED_KEY_NIGHT, true);
	}

	public void setAllowNightEnable(boolean isChecked) {
		editor.putBoolean(SHARED_KEY_NIGHT, isChecked);
		editor.commit();
	}
	// 允许震动
