...
public class SetMyInfoActivity extends ActivityBase implements OnClickListener {
	 private TextView tv_set_name, tv_set_nick, tv_set_gender,user_sign_text;
	 private ImageView iv_set_avator, iv_arraw, iv_nickarraw;
	 private LinearLayout layout_all;
	 private Button btn_chat, btn_back, btn_add_friend;
	 private RelativeLayout layout_head,user_sign, layout_nick, layout_gender, layout_black_tips;
	 private String from = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		stranger=getIntent().getStringExtra("stranger");
	...
	private void initView() {
		...
		user_sign_text=(TextView) findViewById(R.id.user_sign_text);
	...
	private void updateUser(User user) {
		...
		user_sign_text.setText(user.getSignature()==null?"":user.getSignature());
...
//			addBlog();
			break;
		case R.id.user_sign:
			startAnimActivity(UpdateSignActivity.class);
//			addBlog();
			break;
